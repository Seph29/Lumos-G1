...
1. Download the latest release from the **Releases** tab or [here](https://github.com/Seph29/Lumos-G1/releases/download/v1.0.8/lumos-v1.0.8.apk) and beta : [here](https://github.com/Seph29/Lumos-G1/releases/download/v1.0.9/lumos-v1.0.9.apk)
